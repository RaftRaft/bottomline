 ...
 * be returned where the keys are the item names, and the values are arrays of
 * all the items in that item.
 *
 * @param {array} array
 * @param {function} fn Should return a string with a item name
